				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="header.php?tag=student_entry">Students Entry</a></li>
  				  <li><a href="header.php?tag=view_students">View Students</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="header.php?tag=teachers_entry">Teachers Entry</a></li>
  				  <li><a href="header.php?tag=view_teachers">View Teachers</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="header.php?tag=faculties_entry">FA Entry</a></li>
  				  <li><a href="header.php?tag=view_faculties">View FA's</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="header.php?tag=subject_entry">Course Entry</a></li>
  				  <li><a href="header.php?tag=view_subjects">View Courses</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="header.php?tag=score_entry">Grade Entry</a></li>
  				  <li><a href="header.php?tag=view_scores">View Grade</a></li>
  				</ul>
				</div>
